...
typedef struct PKIX_PL_CertDistributionPointStruct
                        PKIX_PL_CertDistributionPoint;
typedef struct PKIX_PL_DistributionPointNameStruct
                        PKIX_PL_DistributionPointName;
typedef struct PKIX_PL_IssuingDistributionPointStruct
                        PKIX_PL_IssuingDistributionPoint;
...
/*  TYPEMACRO(BUILD),  */ \
    ...
    TYPEMACRO(CERTDISTRIBUTIONPOINT), \
...
/*  TYPEMACRO(CONTEXT),  */ \
    ...
    TYPEMACRO(DISTRIBUTIONPOINTNAME), \
...
/*  TYPEMACRO(FATAL), */ \
    ...
    TYPEMACRO(ISSUINGDISTRIBUTIONPOINT), \
/*  TYPEMACRO(LDAPCLIENT), */ \
...
#define PKIX_ERRORCLASSES \
   ...
   ERRMACRO(CERTDISTRIBUTIONPOINT), \
   ...
   ERRMACRO(DISTRIBUTIONPOINTNAME), \
   ERRMACRO(EKUCHECKER), \
   ERRMACRO(ERROR), \
   ERRMACRO(FATAL), \
   ...
   ERRMACRO(INFOACCESS), \
   ERRMACRO(ISSUINGDISTRIBUTIONPOINT), \
   ERRMACRO(LDAPCLIENT), \
...
#define PKIX_ISSUINGDISTRIBUTIONPOINT_OID      "2.5.29.28"
#define PKIX_NAMECONSTRAINTS_OID               "2.5.29.30"
#define PKIX_CRLDISTRIBUTIONPOINT_OID          "2.5.29.31"
