...
function run_test() {
  try {
    ...
    ++testnum; // Test 1 - Get the full card.
    ...
    ++testnum; // Test 2 - convertToEscapedVCard.
    ...
    ++testnum; // Test 3 - convertToXMLPrintData()
    ...
    ++testnum; // Test 4 - convertToBase64EncodedXML()
    ...
    ++testnum; // Last Test - cleanup

    // Null these so that the memory collection can do it right
    childCards = null;
    fullCard = null;
    ...
    throw "FAILED in test_nsIAbCard in test #" + testnum + ": " + e;
  }
}
