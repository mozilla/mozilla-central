/*
 * This file tests copy followed by a move, with the local preference
 * set to quarantine individual messages. Tests issue reported
 * in bug 387361. This test leaks for unknown reasons, as reported
 * in bug 507285.
 *
...
[
  function createFilters() {
    ...
    gFilter.filterType = Ci.nsMsgFilterType.All;
    gFilterList.insertFilterAt(0, gFilter);
    ++gCurTestNum;
    doTest();
  },
  function getLocalMessagesWithFilter() {
    // filter is defined, get messages but this time
  ...
  function verifyFolders1() {
    // Copy and Move should each now have 1 messages in them.
