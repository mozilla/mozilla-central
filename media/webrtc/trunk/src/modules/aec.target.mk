...
$(obj).target/src/modules/libaec.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/src/modules/libaec.a: LIBS := $(LIBS)
$(obj).target/src/modules/libaec.a: TOOLSET := $(TOOLSET)
$(obj).target/src/modules/libaec.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/src/modules/libaec.a
# Add target alias
.PHONY: aec
aec: $(obj).target/src/modules/libaec.a
