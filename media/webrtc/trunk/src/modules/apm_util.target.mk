...
$(obj).target/src/modules/libapm_util.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/src/modules/libapm_util.a: LIBS := $(LIBS)
$(obj).target/src/modules/libapm_util.a: TOOLSET := $(TOOLSET)
$(obj).target/src/modules/libapm_util.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/src/modules/libapm_util.a
# Add target alias
.PHONY: apm_util
apm_util: $(obj).target/src/modules/libapm_util.a
