...
TOOLSET := target
TARGET := system_wrappers_unittests
...
$(OBJS): | $(obj).target/src/system_wrappers/source/libsystem_wrappers.a $(obj).target/testing/libgtest.a $(obj).target/test/libtest_support_main.a $(obj).target/testing/gtest_prod.stamp $(obj).target/test/libtest_support.a $(obj).target/testing/libgmock.a
...
# Add target alias
.PHONY: system_wrappers_unittests
system_wrappers_unittests: $(builddir)/system_wrappers_unittests

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/system_wrappers_unittests
