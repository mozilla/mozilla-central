...
$(obj).target/test/libtest_support.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test/libtest_support.a: LIBS := $(LIBS)
$(obj).target/test/libtest_support.a: TOOLSET := $(TOOLSET)
$(obj).target/test/libtest_support.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/test/libtest_support.a
# Add target alias
.PHONY: test_support
test_support: $(obj).target/test/libtest_support.a
