...
$(obj).target/third_party_mods/libjingle/libjingle_p2p.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/third_party_mods/libjingle/libjingle_p2p.a: LIBS := $(LIBS)
$(obj).target/third_party_mods/libjingle/libjingle_p2p.a: TOOLSET := $(TOOLSET)
$(obj).target/third_party_mods/libjingle/libjingle_p2p.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/third_party_mods/libjingle/libjingle_p2p.a
# Add target alias
.PHONY: libjingle_p2p
libjingle_p2p: $(obj).target/third_party_mods/libjingle/libjingle_p2p.a
