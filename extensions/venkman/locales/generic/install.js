#filter substitution
// variables
var version = "@VENKMAN_VERSION@";
var locale = "@AB_CD@";
var jarFile = "venkman.jar";
var installName = "JavaScript Debugger " + version + " @MOZ_LANG_TITLE@ Language Pack";
...
var err = initInstall(installName, "JavaScript Debugger " + locale, version); 
logComment("initInstall: " + err);

if (verifyDiskSpace(getFolder("Program"), srDest))
{
    addFile("JavaScript Debugger " + locale,
