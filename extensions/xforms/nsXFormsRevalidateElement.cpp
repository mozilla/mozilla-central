...
class nsXFormsRevalidateElement : public nsXFormsActionModuleBase
{
public:
                                              ...
                                              nsIXFormsActionElement *aParentAction)
{
  ...
  return model->Revalidate();
}

NS_HIDDEN_(nsresult)
NS_NewXFormsRevalidateElement(nsIXTFElement **aResult)
{
  *aResult = new nsXFormsRevalidateElement();
  if (!*aResult)
