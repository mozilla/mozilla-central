...
function getBuildId() {
    if (navigator.buildID && /00000000000000/.test(appBuildID)) {
        appBuildID=navigator.buildID;
    } else if (/00000000000000/.test(appBuildID)) {
        try {
...
function resetCriteria() {
  ...
  if (criteria[0].value == 'new') {
    suffix='_new';
    if (appBuildID && appBuildID != "00000000000000") {
