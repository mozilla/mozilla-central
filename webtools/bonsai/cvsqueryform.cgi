...
Between <input type=text name=mindate value='" . &html_quote(&url_decode($::FORM{'mindate'})) . "' size=25></td>
...
<tr>
<td VALIGN=TOP ALIGN=RIGHT NOWRAP>
 and <input type=text name=maxdate value='" . &html_quote(&url_decode($::FORM{'maxdate'})) . "' size=25></td>
</tr>
</table>
</td>
</tr>
